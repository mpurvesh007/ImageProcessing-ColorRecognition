...
def find_circles(image):
    ...
    # Apply median blur to reduce noise in the image with a kernel of 17
...
def correct_image(circle_coordinates, image):
    ...
    if image_name == 'org_2.png' or image_name == 'org_1.png' or image_name == 'org_5.png':
    ...
    if image_name == 'org_3.png' or image_name == 'org_4.png':
         adjusted_coordinates = [
            (circle_coordinates[1][0] + 50, circle_coordinates[1][1] + 50),
            (circle_coordinates[0][0] + 50, circle_coordinates[0][1] -50),
            (circle_coordinates[3][0] -50, circle_coordinates[3][1] -50),
...
filename = "C:\\Users\\Purvesh\\OneDrive\\image processing zip\\images\\org_1.png"
